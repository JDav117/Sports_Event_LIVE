...
export class AttendanceController {
  ...
  @ApiOperation({
    ...
    description:
      'Registra mensajes, feedback táctico, solicitudes de cambio o tiempo fuera',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 400,
    description: 'Solo se puede registrar en eventos en vivo',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Marca a un jugador como presente si estuvo conectado el tiempo mínimo requerido',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'No se puede marcar después de finalizado',
  })
  markAttendance(
  ...
  @ApiOperation({
    ...
    description:
      'Retorna total de presentes, ausentes, tasa de asistencia, promedios, etc.',
  })
  @ApiParam({ name: 'eventId', description: 'ID del evento' })
  ...
  @ApiOperation({
    ...
    description:
      'Marca la asistencia de todos los jugadores conectados al finalizar el evento',
  })
  @ApiParam({ name: 'eventId', description: 'ID del evento' })
